...
from brevitas.quant import Int8WeightPerTensorFixedPoint, BinaryWeight, BinaryAct, QuantType
...
class AlexNetQuant(nn.Module):
    def __init__(self, num_classes=1000, weight_bit_width=1, act_bit_width=1):
        ...
        weight_quant = BinaryWeight if weight_bit_width == 1 else Int8WeightPerTensorFixedPoint
        act_quant = BinaryAct if act_bit_width == 1 else QuantType.INT
